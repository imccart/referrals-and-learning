...
\begin{frame}{The joy of working with Marty}
...
\pause
% Upper image
\node at (0,2) {\includegraphics[width=7cm]{presentations/images/title.png}};
\pause

% Main centered image
\node at (0,0.5) {\includegraphics[scale=2.5]{presentations/images/marty.jpg}};

% Left background image (shifted left and down)
\node at (-3.25,-0.5) {\includegraphics[height=3cm]{presentations/images/nirav.jpg}};

% Right background image (shifted right and down)
\node at (3.25,-0.5) {\includegraphics[height=3cm]{presentations/images/seth.jpg}};
...
% Main centered image (on top)
\node at (0,1) {\includegraphics[height=7cm]{presentations/images/marty_1980s.png}};
\pause

% Left background image (shifted left and down)
\node at (-3.5,-0.25) {\includegraphics[height=4cm]{presentations/images/nirav_1980s.png}};

% Right background image (shifted right and down)
\node at (3.5,-0.25) {\includegraphics[height=3cm, trim = 25 0 40 0, clip]{presentations/images/seth_1980s_2.png}};
...
\textbf{Gaynor}, Propper, and Seiler 2016) % , \emph{MedCareRschRev} , \emph{HandbookHlthEcon} , \emph{HandbookHlthEcon} , \emph{AER} , \emph{AER}
} 
...
\begin{itemize}
    ...
    \item $\gamma$ -- 100 patient increase in volume ($\approx$2/3 std dev) $\rightarrow$ 22\% relative decrease in referral prob.
\end{itemize}
...
\begin{itemize}
    ...
    %%% FIX: Since we cut the estimation period in half, it's not 100 = 2/3 SD any more.
\end{itemize}
