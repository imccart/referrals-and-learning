...
\begin{frame}{Structural Parameter Estimates xxx update} 
...
\ \ ($\eta=1$) & xxx & (0.9275) & & & & -2.1098 & (0.7111) \\ 
\ \ ($\eta=5$) & xxx & (3.2063) & & & & -3.1226 & (1.1708) \\ 
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item $\bar \alpha / \bar \pi$ -- success vs.~failure is worth xxx miles
    (similar to other small estimates in the literature)
    \item $\gamma$ -- 10 patient increase in volume $\rightarrow$ 22\% xxx relative decrease in referral prob.
\end{itemize}
