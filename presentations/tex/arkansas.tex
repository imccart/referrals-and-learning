...
\item We use a structural learning model to measure the effects of uncertainty in physician referrals, and to simulate possible reallocations if there were better information about quality %if learning were improved
...
\multicolumn{5}{l}{\emph{Count per PCP, per year: xxx per doctor, do PCPs out and specs in}}    \\
& Total Referrals     &       4.159&       4.740&       4.477\\
&                     &     (3.089)&     (3.611)&     (3.398)\\
& Unique Specialists xxx  &       2.666&       3.109&       2.910\\
...
\ \ ($\eta=1$) & -0.0913 & (0.0153) & & & & \multicolumn{2}{c}{\color{spiritblue} estimation} \\ 
...
\begin{frame}[t]{Partial Effect of Failures xxx} 
\begin{center}
\begin{tabular}{cc}
...
\begin{frame}[b]{Counterfactual: health outcomes under full information xxx} 
