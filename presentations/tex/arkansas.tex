...
\item Find that one-quarter xxx of referrals would be reallocated under full information, \\
...
\emph{Average number of specialists per market (HRR): 83 xxx changed?}
...
\emph{Dep.~var.~mean = 0.194 (treated group before event), relative reduction is 25\% xxx check/update}
...
\begin{frame}[t]{Counterfactual: reallocation under full information xxx} 
...
%    \bigskip
    ...
    \bit
        \item One-quarter xxx of patients would be reallocated under perfect information
