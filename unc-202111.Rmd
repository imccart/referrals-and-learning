...
| Variable           |   (1)       |   (2)      |      (3)   |   (4)      |
|:-------------------|------------:|-----------:|-----------:|-----------:|
| Pair Failure Rate  | -0.051      | 0.008      | 0.042      | -0.015     |
|                    |**[-0.004]** |**[0.000]** |**[0.003]** |**[-0.001]**|
| "Attachment"       |             | 5.008\***  | 4.378\***  | 5.378\***  |
|                    |             |**[0.295]** |**[0.265]** |**[0.284]** |
| **Specification**  |             |            |            |            |
...
- Calculate Gittins Index and include as covariate
- Coefficient estimates large and of opposite sign
- Why?
  - Incorrect formulation of Gittins Index
  - Referrals inconsistent with Bayesian learning
--

- What next?
  - Consider strength of priors and discount factor required for expected sign
  - Parameterize Gittins Index directly (Gong, 2017; Dickstein, 2018)
