...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2009;
CREATE TABLE IMC969SL.Hospital_Location_2009 AS
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2010;
CREATE TABLE IMC969SL.Hospital_Location_2010 AS
	SELECT a.*, b.FACILITY_NAME AS Hosp_Name_POS, b.FIPS_CNTY AS Hosp_County_POS, b.FIPS_STATE AS Hosp_State_POS,
		b.PROV_NUM AS Provider_Number, b.PARENT_PROV_NUM AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2011;
CREATE TABLE IMC969SL.Hospital_Location_2011 AS
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2012;
CREATE TABLE IMC969SL.Hospital_Location_2012 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2013;
CREATE TABLE IMC969SL.Hospital_Location_2013 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2014;
CREATE TABLE IMC969SL.Hospital_Location_2014 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2015;
CREATE TABLE IMC969SL.Hospital_Location_2015 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2016;
CREATE TABLE IMC969SL.Hospital_Location_2016 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2017;
CREATE TABLE IMC969SL.Hospital_Location_2017 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
DROP TABLE IMC969SL.Hospital_Location_2018;
CREATE TABLE IMC969SL.Hospital_Location_2018 AS
	SELECT a.*, b.FAC_NAME AS Hosp_Name_POS, b.FIPS_CNTY_CD AS Hosp_County_POS, b.FIPS_STATE_CD AS Hosp_State_POS,
		b.PRVDR_NUM AS Provider_Number, b.PARENT_PROVIDER_NUMBER AS Parent_Provider_Number, b.ZIP_CD AS Hosp_Zip_POS
	FROM WORK.Hospital_Location AS a
...
PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2009;
	CREATE TABLE IMC969SL.BENE_Data_2009 AS
...
PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2010;
	CREATE TABLE IMC969SL.BENE_Data_2010 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
...
PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2011;
	CREATE TABLE IMC969SL.BENE_Data_2011 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
		FROM MBSF.MBSF_ABCD_2011;
QUIT;

PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2012;
	CREATE TABLE IMC969SL.BENE_Data_2012 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
...
PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2013;
	CREATE TABLE IMC969SL.BENE_Data_2013 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
		FROM MBSF.MBSF_ABCD_2013;
QUIT;

PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2014;
	CREATE TABLE IMC969SL.BENE_Data_2014 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
		FROM MBSF.MBSF_ABCD_2014;
QUIT;

PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2015;
	CREATE TABLE IMC969SL.BENE_Data_2015 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
		FROM MBSF.MBSF_ABCD_2015;
QUIT;

PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2016;
	CREATE TABLE IMC969SL.BENE_Data_2016 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
		FROM MBSF.MBSF_ABCD_2016;
QUIT;

PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2017;
	CREATE TABLE IMC969SL.BENE_Data_2017 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
...
PROC SQL;
	DROP TABLE IMC969SL.BENE_Data_2018;
	CREATE TABLE IMC969SL.BENE_Data_2018 AS
		SELECT BENE_ID, ZIP_CD AS BENE_ZIP, BENE_BIRTH_DT, BENE_DEATH_DT, SEX_IDENT_CD AS BENE_Gender, BENE_RACE_CD AS BENE_Race
