...
\centering
\begin{minipage}[h]{6in}
\caption[caption]{Counterfactual Changes with Full Information, Existing Familiarity\footnote{Figure depicts the share of referrals reallocated and the resulting effects on patient health and episode spending under a counterfactual in which PCPs have full information about specialist quality and in which familiarity is initialized to observed values as of January 2013. Estimates are averaged across individuals within an HRR and presented as a histogram across HRRs. Results limited to HRRs in which our constrained maximization routine converged, \nHRRsMyopic{} (\nHRRsFWD{}) HRRs in the myopic (forward-looking) case for $\eta=1$ and \nHRRsEtaFiveMyopic{} (\nHRRsEtaFiveFWD{}) in the myopic (forward-looking) case for $\eta=5$.}}
\centering
\begin{tabular}{cc}
\multicolumn{2}{c}{\textit{Reallocation of referrals under myopic behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Current_Myopic_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Reallocation of referrals under forward-looking behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Current_FWD_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Current_FWD_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under myopic behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Current_Myopic_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under forward-looking behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Current_FWD_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Current_FWD_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in episode spending under myopic behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Spend_FX_current_Myopic_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Spend_FX_current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in episode spending under forward-looking behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Spend_FX_current_FWD_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Spend_FX_current_FWD_eta5.png}
\end{tabular}
...
\begin{tabular}{cc}
\multicolumn{2}{c}{\textit{Reallocation of referrals under myopic behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Full_Myopic_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Full_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Reallocation of referrals under forward-looking behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Full_FWD_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Full_FWD_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under myopic behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Full_Myopic_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Full_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under forward-looking behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Full_FWD_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Full_FWD_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in episode spending under myopic behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Spend_FX_full_Myopic_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Spend_FX_full_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in episode spending under forward-looking behavior}} \\
\includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Spend_FX_full_FWD_eta1.png} & \includegraphics[height=1.2in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Spend_FX_full_FWD_eta5.png}
\end{tabular}
\label{fig:cf_full}
\end{minipage}
\end{figure}
