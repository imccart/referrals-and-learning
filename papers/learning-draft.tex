...
The results under ``resetting familiarity'' are summarized in Figure \ref{fig:cf_full}, where we find that about 40\% of existing referrals would be reallocated. This represents a substantial change in demand for many specialists. The changes in health outcomes are more modest, which is not surprising given the relatively small average failure rate. Under full information, the probability of a negative outcome falls by about 0.5 percentage points relative to the average failure rate of around 0.09.
...
\centering
\begin{minipage}[h]{6in}
\caption[Hypothetical Reallocation]{\textbf{Hypothetical Reallocation} (by hospital referral region)\footnote{Figure depicts the count of procedures among the lowest 25th percentile of specialists, aggregated across all specialists in a given HRR.}}
\centerline{%
...
\includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Full_Myopic_eta1.png} & \includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Full_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Myopic Referrals, Health Improvements}} \\
\includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Full_Myopic_eta1.png} & \includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Full_Myopic_eta5.png} \\
...
\includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Full_FWD_eta1.png} & \includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Full_FWD_eta5.png}
\end{tabular}
\label{fig:cf_full}
\end{minipage}
\end{figure}
...
\begin{tabular}{cc}
\multicolumn{2}{c}{\textit{Myopic Referrals, Reallocation}} \\
\includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Current_Myopic_eta1.png} & \includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Myopic Referrals, Health Improvements}} \\
\includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Current_Myopic_eta1.png} & \includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Forward-looking Referrals, Reallocation}} \\
...
\multicolumn{2}{c}{\textit{Forward-looking Referrals, Health Improvements}} \\
\includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Current_FWD_eta1.png} & \includegraphics[height=3in,width=2.7in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Current_FWD_eta5.png}
