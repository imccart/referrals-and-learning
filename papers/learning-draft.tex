...
\centering
\begin{minipage}[h]{6in}
\caption[Gradient of Health Effects]{Health Effects of Full Information by Estimated Learning Parameter\footnote{Figure depicts the mean change in failures per 10,000 patients under each counterfactual, binned into ten patient-weighted quantiles of the estimated learning parameter $\hat\alpha$ within each HRR ($\hat\alpha > 0.001$). Marker size reflects the total patients in the bin. Results shown for $\eta=1$; corresponding figures for $\eta=5$ appear in the supplemental appendix.}}
\centering
\begin{tabular}{cc}
\multicolumn{2}{c}{\textit{Myopic behavior}} \\
