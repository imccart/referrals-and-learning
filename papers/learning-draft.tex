...
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Full_Myopic_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Full_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Reallocation of referrals under forward-looking behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Full_FWD_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Full_FWD_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under myopic behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Full_Myopic_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Full_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under forward-looking behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Full_FWD_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Full_FWD_eta5.png}
\end{tabular}
\label{fig:cf_full}
\end{minipage}
\end{figure}
...
\begin{tabular}{cc}
\multicolumn{2}{c}{\textit{Reallocation of referrals under myopic behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Current_Myopic_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Reallocation_Current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Reallocation of referrals under forward-looking behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Current_FWD_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Reallocation_Current_FWD_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under myopic behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Current_Myopic_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/myopic-timevary/Mean_Health_FX_Current_Myopic_eta5.png} \\
\multicolumn{2}{c}{\textit{Change in probability of success under forward-looking behavior}} \\
\includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Current_FWD_eta1.png} & \includegraphics[height=1.5in,width=2.5in,keepaspectratio]{results/figures/fwd-timevary/Mean_Health_FX_Current_FWD_eta5.png}
\end{tabular}
