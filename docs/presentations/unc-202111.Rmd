...
- Limited to primary care specialty codes
- Limited to established or will-be-established PCPs
  
--

- Specialist is operating physician listed on the claim
- Limited to orthopedic surgeons
...
- 2 percentage point reduction in referral probability (relative to most common)
- Mean range of failure rates by case: 0 to 50%
- Mean failure rate of 9.5%
- 80,000 cases total
- 33% to most common referral
...
ci.plot <- dwplot(mfx,whisker_args=list(color="black", size=1.1),
