...
\noindent \textbf{Anticipated Budget:} \$125,000

\vspace{.2in}
\noindent \textbf{Summary of Proposed Work:} This project investigates how primary care physicians (PCPs) refer patients for elective surgery and whether new care delivery models improve referral efficiency. Using Medicare claims linked across patients, PCPs, and specialists, we document substantial within-market variation in specialist quality and cost—yet many patients are referred to underperforming providers despite the availability of high-performing alternatives. We estimate a structural model of physician learning under uncertainty to assess how referral behavior responds to outcome feedback, informational frictions, and institutional constraints. This model enables simulations of policy interventions such as referral dashboards, peer comparison tools, and bonus structures for high-value referrals. We also directly evaluate whether PCPs participating in Accountable Care Organizations (ACOs) or exposed to shared savings contracts exhibit more efficient referral patterns, offering insight into how delivery system reforms affect provider behavior. This work informs scalable strategies to improve care coordination and affordability through smarter referral decisions.
...
\vspace{.2in}
\noindent \textbf{Research Design:} We use 100\% of Medicare fee-for-service claims from 2008 to 2018, linked with the Medicare Beneficiary Summary File, MD-PPAS (physician characteristics), and AHA Annual Surveys (hospital characteristics). We will focus on elective inpatient surgeries (e.g., joint replacement, spinal fusion) and the associated referral paths. The analytic unit is the patient-procedure, with each patient linked to the referring PCP and operating specialist.
