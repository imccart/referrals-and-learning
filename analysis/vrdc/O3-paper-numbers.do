...
file write fh "%% Auto-generated by O3-paper-numbers.do — do not edit by hand" _n
file write fh "\newcommand{\nPCPs}{`n_pcps'}" _n
...
file write numfh "%% Auto-generated by O3-paper-numbers.do — do not edit by hand" _n
	...
	** mean reallocation and health effects (conditional on alpha>0)
	foreach eta in 1 5 {
		...
		** Current info counterfactual
		use "${RESULTS_FINAL}CounterFactualsSummary_current_`model'`eta'.dta", clear
		merge 1:1 hrr using hrr_size, nogenerate keep(master match)
		keep if coef_m>0
		qui sum pij_diff_cf [aweight=patients]
