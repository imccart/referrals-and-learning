...
log using "${LOG_PATH}CF_Current_${MODEL_TYPE}_`logdate'.log", replace

******************************************************************
**	Title:		Counterfactual — Full Info, Existing Familiarity
**	Author:		Ian McCarthy
**	Date Created:	3/30/2026
**	Notes:		Requires base_hrr files from O2-baseline.do.
**			m = spec_qual, base_patients = start_patients_run (converge_dyn).
******************************************************************
